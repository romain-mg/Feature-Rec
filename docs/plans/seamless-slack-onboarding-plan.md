...
- Add `channels:read` and `groups:read` to the existing `chat:write`, `files:write`,
  and `usergroups:read` scopes (`commands` rides along with the slash
...
| 9   | Rewrite README and `docs/setup-and-operations.md` around three-step onboarding; add Slack setup appendix                                                                                                                                                                                                                        | docs                                                      |
