...
sequenceDiagram
    ...
    alt duplicate (existing status not failed)
        ...
        loop each superseded old cycle — fired async, best-effort with retry, never blocks or fails /start
